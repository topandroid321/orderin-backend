@extends('layouts.master_template')
    @section('content')
    <div class="py-1">
        <h1 class="h5">Add Data Product</h1>
        <p>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 py-5">
            <div class="">
                <div>
                    ...
                    @endif
                    <form action="{{ route('products.store') }}" class="w-full" method="post" enctype="multipart/form-data">
                        @csrf 
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <input value="{{ old('price') }}" name="price" class="appearance-none block w-full bg-gray-200 text-gray-700 border py-3 px-4 border-gray-200 leading-tight focus:bg-white focus:outline-none focus:border-gray-500" id="grid-last-name" type="text" placeholder="Price">
                            </div>
                        </div>
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">Descriptions</label>
                                <input value="{{ old('description') }}" name="description" class="appearance-none block w-full bg-gray-200 text-gray-700 border py-4 px-3 border-gray-200 leading-tight focus:bg-white focus:outline-none focus:border-gray-500" id="grid-last-name" type="text" placeholder="Description">
                            </div>
                        </div>
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">Stock</label>
                                <input value="{{ old('stock') }}" name="stock" class="appearance-none block w-full bg-gray-200 text-gray-700 border py-4 px-3 border-gray-200 leading-tight focus:bg-white focus:outline-none focus:border-gray-500" id="grid-last-name" type="text" placeholder="Stock">
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <input value="{{ old('tags') }}" name="tags" class="appearance-none block w-full bg-gray-200 text-gray-700 border py-4 px-3 border-gray-200 leading-tight focus:bg-white focus:outline-none focus:border-gray-500" id="grid-last-name" type="text" placeholder="Tags">
                            </div>
                        </div>
